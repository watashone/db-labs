...
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Відвідувач обирає опцію "Пошук" на головній сторінці.<br/> 2. Відвідувач вводить запит у пошуковий бар.<br/> 3. Відвідувач натискає "Знайти".<br/> 4. Система шукає в системі відповідні дані.<br/> 5. Cистема відображає результати пошуку.<br/> 6. Відвідувач отримує шукані дані. |
...
@startuml
    ...
    |Відвідувач|
        start
        : Обирає опцію "Завантажити дані";
        : Обирає тип даних для завантаження;
    |Система|
...
@startuml
    ...
    |Користувач|
        start
        : Обирає "Завантажити дані в систему";
        : Вводить необхідну інформацію для завантаження;
...
@startuml
    ...
    |Користувач|
        start
        : Обирає "Візуалізація даних";
        : Обирає необхідні параметри для візуалізації;
        : Натискає "Підтвердити";
    |Система|
        : Опрацьовує запит користувача;
        note right #ffaaaa
        <b>Можлива виключна ситуація!</b>
        <b>Немає доступних даних - NoDataAvailable</b>
        end note
...
@startuml
    ...
    |Користувач|
        start
        : Обирає опцію "Залишити коментар";
...
@startuml
    ...
    |Користувач|
        start
        : Обирає опцію "Увійти" в меню акаунта;
...
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Користувач обирає опцію "Вийти" в меню акаунта.<br/> 2. Система опрацьовує запит на вихід.<br/> 3. Система деавторизовує користувача.<br/> 4. Система надсилає підтвердження про успішну деавторизацію.<br/> 5. Користувач отримує підтвердження про успішну деавторизацію.<br/> 6. Система перенаправляє користувача на головну сторінку. |
...
@startuml
    ...
    |Адміністратор|
        start
        : Обирає "Видалити дані";
        : Вводить дані для видалення;
        : Натискає "Підтвердити";
    |Система|
...
@startuml
    ...
    |Адміністратор|
        start
        : Обирає опцію "Реєстрація";
        : Вводить необхідну інформацію (логін, електронна пошта, пароль);
        : Натискає "Створити акаунт";
    |Система|
        : Опрацьовує запит адміністратора;
        note right #ffaaaa
...
@startuml
    ...
    |Система|
        ...
        : Надсилає підтвердження про успішну деавторизаціюю;
    |Адміністратор|
        : Отримує повідомлення про успішну деавторизацію;
    |Система|
        : Перенаправляє адміністратора на головну сторінку;
    |Адміністратор|
        : Закінчує взаємодію;
