...
Створення та впровадження конкурентоспроможної системи управління відкритими даними, що показує найвищі показники у функціональності та атрибутах якості, враховуючи недоліки вже існуючих систем.
